...
<body>
	...
	<div class="list">
		<div class="container">
			<div class="list-info">
				<h3 class="type">Cloud Annovar</h3>
			</div>

			<form method="post" action="cAnnovar_processing.jsp" name="upform"
				enctype="multipart/form-data">
				<div class="grid_3 grid_44">
					<h3>Step 1: Upload vcf</h3>
